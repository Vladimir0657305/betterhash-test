...
jQuery(document).ready(function($) {
	...
	if (typeof $( '.contact_email2_wrap' ) !== 'undefined' ) {
		if ($( '.contact_email2_wrap' ).hasClass( 'col-sm-4' )) {
			$( '.contact_email2_wrap' ).removeClass( 'col-sm-4' );
		}
		if ($( '.contact_email2_wrap' ).hasClass( 'col-lg-4' )) {
			$( '.contact_email2_wrap' ).removeClass( 'col-lg-4' );
		}
		$( '.contact_email2_wrap' ).addClass( 'col-md-6' );
		$( '.contact_email2_wrap .form-group' ).addClass( 'label-floating' );
		var placeholder3 = $( '.contact_email2_wrap #pirate-forms-contact-email2' ).attr( 'placeholder' );
		$( '.contact_email2_wrap #pirate-forms-contact-email2' ).removeAttr( 'placeholder' );
		$( '<label class="control-label"> '+placeholder3+' </label>' ).insertBefore( '.contact_email2_wrap #pirate-forms-contact-email2' );
	}
